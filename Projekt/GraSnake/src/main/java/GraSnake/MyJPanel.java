...
public class MyJPanel extends JPanel implements ActionListener {
    ...
    //WSZYSTKIE ZMIENNE 
    private final int Szerokosc = 500;
    private final int Wysokosc = 500;
    private final int Wielkosc_Weza = 20;
    private final int cala_dlugosc = (Szerokosc*Wysokosc)/10;
    private final int rando = ((Szerokosc+Wysokosc)/20)-40;
    ...
    private Image owoc;
    private Image glowa;
    private Image glowap;
    private Image glowad;
    private Image glowag;
    private Image glowal;


//        bi2 = ImageIO.read(new File("src/resources/glowkadol"));
...
//    private Graphics2D owoc;
    ...
    public void paintComponent(Graphics g) {
        ...
        for(int i=10;i<=Szerokosc;i+=20){
            g2d.drawLine(i, 0, i, Wysokosc);
        }
        for(int i=10;i<=Wysokosc;i+=20){
...
//      ZDJECIA UZYWANE W GRZE
    ...
    private void Zdjecia() {
        ...
        ImageIcon iid = new ImageIcon("src/resources/cialo.png");
        Tulow = iid.getImage();

        ImageIcon iia = new ImageIcon("src/resources/owoc1.png");
        owoc = iia.getImage();
               ImageIcon iihp = new ImageIcon("src/resources/1.png");
               glowa=iihp.getImage();
//       ImageIcon iihl = new ImageIcon("src/resources/1.png");
//     glowal=iihl.getImage();
//      ImageIcon iihg = new ImageIcon("src/resources/4.png");
//      glowag=iihg.getImage();
//       ImageIcon iihd = new ImageIcon("src/resources/3.png");
//       glowad=iihd.getImage();
        repaint();
    }
...
//       RYSOWANIE WEZA WEZA
    private void Rysowanie(Graphics g) {
        ...
        if (gra) {
            ...
            g.drawImage(owoc, (owocX+10), (owocY+10), this);
